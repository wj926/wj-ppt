...
import { checkHome, checkUploadEditSave, checkMultislide, checkPageNav, checkUndoRedo, checkPropPanel, checkEditingFixes, checkResizeHandle, checkPresentMode, checkOverlayClickthrough, checkPasteAndDelete, checkPdfExport, checkImagePersist, checkUploadPrecheck, checkMobileLayout } from "../lib/checks.mjs";
...
const STEPS = [
  ...
  ["overlay-clickthrough", checkOverlayClickthrough],
